...
adaptiveGMMlasso_normal_for15<-function(UKBB_pop,study_info,cor_cut=0.5,filter_index=TRUE,p_val_cut=1e-5){
  UKBB_cor<-cor(UKBB_pop[,-1])
  diag(UKBB_cor) = 0
  if(filter_index){
    ### Trick 1 index filtering 
...
adaptiveGMMlasso35<-function(UKBB_pop,study_info,cor_cut0=0.8,cor_cut=0.7,filter_index=TRUE,p_val_cut=1e-5){
  UKBB_cor<-cor(UKBB_pop[,-1])
  diag(UKBB_cor) = 0
  if(filter_index){
    ### Trick 1 index filtering 
