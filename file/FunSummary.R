...
#' @return nothing useful
#'
#' @importFrom reticulate py_run_string import_main py_get_attr py_module_available py_set_seed
#'
#' @export
#'
#' @examples
...
RunAdaUMAP<-function(
  ...
  py_func_names<-c("adaptive_euclidean_grad","adaptive_euclidean2_grad")
