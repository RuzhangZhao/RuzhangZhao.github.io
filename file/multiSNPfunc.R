...
adaptiveGMMlasso<-function(UKBB_pop,N_SNP,study_info){
  ...
  #ridge_fit<-glmnet(x= (pseudo_X),y= (pseudo_y),standardize=F,intercept=F,lambda = lambda_list[100],alpha = 0)
  ...
  aa_final<-1-pnorm(sqrt(N_Pop)*beta[index_nonzero]/sqrt(final_v))
